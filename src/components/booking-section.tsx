                            ...
                            {vehicles.map((vehicle) => {
                                ...
                                return (
                                  <div key={vehicle.name}>
                                    ...
                                    >
                                      <Card className="w-48 overflow-hidden transition-all border-2 border-muted hover:border-primary/50 peer-data-[state=checked]:border-primary peer-data-[state=checked]:ring-2 peer-data-[state=checked]:ring-offset-2 peer-data-[state=checked]:ring-offset-background peer-data-[state=checked]:ring-primary">
